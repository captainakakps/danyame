    ...
    <div className="relative z-10 flex w-full shrink-0 items-center justify-between px-6 py-6 md:px-10 md:py-8 lg:px-14">
      ...
      <div className="relative">
        <button
          ...
          className="flex h-[44px] w-[100px] items-center justify-center gap-2 rounded-[100px] bg-rust px-4 text-[14px] font-medium text-white md:h-[50px] md:w-[123px] md:gap-3 md:px-6 md:text-base"
        ...
        {isMenuOpen && (
          <>
            ...
            <div
              className="fixed right-4 top-4 z-[9999] max-h-[calc(100vh-2rem)] w-[280px] overflow-y-auto rounded-[20px] border border-[rgba(230,230,230,0.5)] bg-white px-4 pb-6 pt-4 shadow-xl md:right-auto md:left-1/2 md:top-[100px] md:-translate-x-1/2"
