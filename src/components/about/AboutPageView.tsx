...
function ImageCard({
  ...
  return (
    <div className={`relative overflow-hidden rounded-[20px] ${className ?? ""}`}>
      ...
      />
      <div className="absolute inset-0 rounded-[20px] bg-black/20" aria-hidden />
    </div>
  );
}
  ...
  return (
    <div className="overflow-x-hidden bg-white">
      ...
      <section className="bg-white px-6 pb-8 pt-12 sm:px-8 sm:pt-16 md:px-10 md:pt-20 lg:px-14 lg:pb-8 lg:pt-[130px]">
        <div className="mx-auto flex max-w-[1328px] flex-col gap-16 lg:gap-[120px]">
          <div className="flex flex-col gap-8 lg:relative lg:h-[232px] lg:gap-0">
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-start lg:justify-between lg:gap-8">
            <div className="flex flex-col gap-6 sm:flex-row sm:gap-8">
              ...
              <div className="relative flex aspect-[250/303] w-full flex-col justify-between overflow-hidden rounded-[20px] p-4 sm:w-[220px] lg:h-[303px] lg:w-[250px]">
                <Image
      ...
      <section className="bg-white px-6 py-12 sm:px-8 md:px-10 lg:px-14 lg:py-0">
        <div className="mx-auto flex max-w-[1328px] flex-col gap-10 lg:h-[707px] lg:flex-row lg:items-start lg:justify-between lg:gap-16 lg:pt-[100px]">
          <div className="flex w-full flex-col gap-8 lg:max-w-[454px]">
            <p
        ...
        <div className="strip-container overflow-hidden">
          <div className="animate-strip flex w-max">
            {[...page.stripImages, ...page.stripImages].map((image, i) => (
              <div
                key={`${image.src}-${i}`}
                className="relative aspect-[325/433] w-[200px] shrink-0 border-[3px] border-white sm:w-[260px] md:w-[20vw] lg:w-[340px]"
              >
                <Image
                  src={image.src}
                  alt={image.alt}
      ...
      <section className="bg-white px-6 py-16 sm:px-8 md:px-10 lg:px-14 lg:py-[150px]">
        <div className="mx-auto flex max-w-[1328px] flex-col gap-16 lg:flex-row lg:gap-[120px]">
          {([page.missionVision.mission, page.missionVision.vision] as const).map(
            (item) => (
              <div key={item.title} className="flex flex-1 flex-col gap-8 lg:gap-10">
                <div className="relative h-[88px] w-[88px] sm:h-[114px] sm:w-[114px]">
      ...
      <section className="relative w-full overflow-hidden">
        ...
        <div className="relative flex min-h-[450px] items-center justify-center px-6 py-16 sm:min-h-[550px] md:min-h-[700px] lg:min-h-[900px]">
          <div className="flex max-w-[707px] flex-col items-center gap-6 md:gap-[30px]">
            <div className="relative h-[48px] w-[32px] sm:h-[56px] sm:w-[37px] md:h-[64px] md:w-[42px]">
              <Image
      ...
      <section className="bg-white px-6 py-16 sm:px-10 md:px-16 lg:px-20 lg:py-[130px]">
        <div className="mx-auto flex max-w-[1280px] flex-col items-center gap-8 lg:gap-10">
          <h2
